      ...
      <table>
         ...
         <div class="form-control">
                ...
                <div class="mt-1 col-sm-14">
	               <label>6시간 : </label>
	               <input type="text" name="space_6Hprice">원
	               
	               <label>종일 : </label>
	               <input type="text" name="space_AllPrice">원
               </div>
           </div>
         <br>
         <tr>
         ...
         <tr>
            ...
            <td><textarea cols="80" rows="10" name="space_content" id="space_content">${view.content}</textarea></td>
         </tr>
         <tr>
